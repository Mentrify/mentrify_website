    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center text-center overflow-hidden bg-white">
        ...
        <div
          ...
          className="relative z-10 px-6 max-w-4xl opacity-0"
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="text-gray-900 font-semibold">seniors</span> who
            truly understand their journey. Real experiences, honest guidance,
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                At Mentrify, our vision is to make mentorship a part of every
                student's journey. We aim to empower young learners with the
                right guidance, helping them make informed choices, build
                confidence, and unlock opportunities for a brighter future.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Our mission is to connect students with mentors who understand
                their challenges and aspirations. By creating a platform where
                knowledge, experiences, and guidance are shared, we strive to
                bridge the gap between academics and real-world decisions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                <p>
                  Mentrify is built by a passionate team of{" "}
                  <span className="text-gray-900 font-semibold">
                    graduating students
                  </span>{" "}
                  who know firsthand the challenges that come with academic
                  transitions and career choices.
                </p>
                <p>
                  Having recently gone through the same journey, we understand
                  the struggles, doubts, and aspirations of 12th-grade students.
                  Our shared experiences drive us to create a supportive
                  ecosystem where mentorship is not just advice but a{" "}
                  <span className="text-gray-900 font-semibold">
                    relatable and impactful exchange
                  </span>{" "}
                  of knowledge.
                </p>
              </div>
              ...
              <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-12 border border-gray-100">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Built with empathy, designed for impact
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We connect 12th-grade students with mentors who can guide them in
              academics, career paths, and personal growth.
            </p>
          </div>
            ...
            {[
              ...
              <div key={i} className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                  <div
                    className={`w-14 h-14 rounded-xl bg-gradient-to-r ${item.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                  >
            ...
            {[
              ...
              >
                <div className="bg-white rounded-2xl border-2 border-gray-100 hover:border-gray-200 p-8 text-center transition-all duration-300 hover:shadow-lg h-full">
                  <div
                    className={`w-16 h-16 ${value.bg} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}
                  >
      ...
      <section
        ...
        className="py-24 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 text-center opacity-0 relative overflow-hidden"
      >
        {/* Background elements */}
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          <h2 className="text-5xl md:text-6xl font-bold mb-8 text-gray-900 leading-tight">
            Join the Future of{" "}
            <span className="apple-gradient-text">Mentorship</span>
          </h2>
