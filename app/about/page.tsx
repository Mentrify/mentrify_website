      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-12 pt-[150px]">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="font-semibold text-gray-900">seniors</span> who
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 mb-4">
            ...
            <div className="md:col-span-6 lg:col-span-5 bento-card liquid-glass-accent rounded-[2rem] p-8 md:p-10">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                knowledge, experiences, and guidance are shared, we bridge the
                gap between academics and real-world decisions.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 mb-4">
            ...
            <div className="md:col-span-6 lg:col-span-5 bento-card liquid-glass-strong rounded-[2rem] p-8 md:p-10">
              ...
              <p className="text-gray-700 leading-relaxed">
                Having recently gone through the same journey, we understand the
                struggles, doubts, and aspirations of 12th-grade students.
              </p>
            </div>
            ...
            <div className="md:col-span-6 lg:col-span-7 bento-card liquid-glass-accent rounded-[2rem] p-8 md:p-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="liquid-glass rounded-2xl p-6 text-center bento-card">
                  <GraduationCap
                    className="h-10 w-10 text-gray-700 mx-auto mb-4"
                    strokeWidth={1.5}
                  />
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Access to relatable, real-world insights from students who
                    have recently navigated the same stage
                  </p>
                </div>
                <div className="liquid-glass rounded-2xl p-6 text-center bento-card">
                  <BookOpen
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Comprehensive resources and guidance materials to support
                    your academic and career decisions
                  </p>
                </div>
                <div className="liquid-glass rounded-2xl p-6 text-center bento-card">
                  <Heart
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Join a network of learners and mentors who grow, share, and
                    succeed together
                  </p>
                </div>
              </div>
