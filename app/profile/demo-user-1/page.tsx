...
// This page is fully API-driven. No local demo/sample data or localStorage fallbacks.
...
export default function MenteeProfilePage() {
  ...
  const resetDemo = () => {
    // resetDemo removed — demo reset behavior disabled
  };
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6 max-w-lg mx-auto">
                  Your journey starts here. Find the perfect mentor to guide you
                  or check on your upcoming sessions.
                </p>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                <div className="flex gap-3">
                  <Button
                    onClick={saveProfile}
                    disabled={saving}
                    className="bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold px-6 py-2 rounded-lg flex items-center gap-2"
                  >
                    {saving ? (
                      <>
