...
function MentorCard({ mentor }: { mentor: Mentor }) {
  return (
    <div className="group cursor-pointer">
      <div className="relative rounded-[24px] overflow-hidden bg-white shadow-md border border-gray-100 transition hover:shadow-lg">
        <div className="relative h-[280px] overflow-hidden">
          {mentor.image ? (
            <Image
              src={mentor.image}
        ...
        <div className="px-6 pt-5 pb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">{mentor.college}</p>
          ...
          <Link
            href={`/mentor/${mentor.id}`}
            className="block w-full mt-5 py-3 rounded-xl text-center bg-gray-900 text-white text-sm font-semibold hover:bg-black transition"
          >
            Schedule Session
          </Link>
        </div>
        ...
        <div className="mb-10 flex justify-center">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full pl-11 pr-10 py-2.5 border border-slate-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            {searchTerm && (
              <button
                onClick={() => setSearchTerm("")}
