      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-12 pt-[150px]">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            We believe mentorship goes beyond scheduled calls — it's about
            building a{" "}
            <span className="font-semibold text-gray-900">
              supportive, collaborative, and inspiring community
            </span>{" "}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-4 mb-4">
            ...
            <div className="md:col-span-6 lg:col-span-5 bento-card liquid-glass-strong rounded-[2rem] p-8 md:p-10 flex flex-col justify-between">
              <div>
                <MessageCircle
                  className="h-12 w-12 text-[#5865F2] mb-6"
                  strokeWidth={1.5}
                />
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  Connect with mentors and fellow students in real-time. Get
                  instant guidance, share experiences, and grow together in our
                  vibrant community.
                </p>
              </div>
              <Link
                href="https://discord.com/channels/1394744987706593370/1394744988558168065"
                target="_blank"
            ...
            <div className="md:col-span-6 lg:col-span-7 bento-card liquid-glass-accent rounded-[2rem] p-8 md:p-10">
              <Lightbulb
                className="h-10 w-10 text-gray-700 mb-6"
                strokeWidth={1.5}
              />
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                Our Mission
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                ...
                — a space where curiosity thrives, doubts turn into learning,
                and mentorship turns into friendship.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="liquid-glass rounded-2xl p-6 bento-card">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    When a student joins our Discord community, they start by
                    opening a support ticket and answering a few quick questions
                  </p>
                </div>
                ...
                <div className="liquid-glass rounded-2xl p-6 bento-card">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    This helps us understand their background, interests, and
                    learning goals. Once verified, they gain full access to the
                    server
                  </p>
                </div>
                ...
                <div className="liquid-glass rounded-2xl p-6 bento-card">
                  ...
                  <p className="text-gray-600 leading-relaxed text-sm">
                    Access channels for discussions, mentorship, and networking
                    with verified mentors and fellow students
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="bento-card liquid-glass-strong rounded-[2rem] p-8">
              <div className="flex items-start gap-4">
                <Zap
                  className="h-10 w-10 text-gray-700 shrink-0"
                  strokeWidth={1.5}
                />
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">
                    Easy Mentorship Access
                  </h3>
                  <p className="text-gray-700 leading-relaxed">
                    For smaller doubts or quick guidance, students can directly
                    ping their mentors on Discord chat without needing to
                    schedule a call. This makes learning instant, personal, and
                    engaging.
                  </p>
                </div>
              </div>
            ...
            <div className="bento-card liquid-glass-accent rounded-[2rem] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Mentrify isn't about business, it's about building
                    meaningful relationships and creating impact through peer
                    and mentor support.
                  </p>
                </div>
              </div>
            ...
            <div className="bento-card liquid-glass-accent rounded-[2rem] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Our community fosters collaboration among learners, helping
                    them share experiences, grow together, and build lasting
                    friendships.
                  </p>
                </div>
              </div>
            ...
            <div className="bento-card liquid-glass-strong rounded-[2rem] p-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Mentors can connect among themselves, forming a network of
                    passionate guides dedicated to student success and mutual
                    growth.
                  </p>
                </div>
              </div>
